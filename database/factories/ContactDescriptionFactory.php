...
$factory->define(ContactDescription::class, function (Faker $faker) {
    $description =  "Lorem Ipsum is simply dummy text of the printing and typesetting industry.
        ...
        (injected humour and the like). There are many variations of passages of Lorem Ipsum available,
    ...
    return [
        'contact_id' => factory('App\Contact'),
